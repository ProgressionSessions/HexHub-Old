...
local CurrentDiscordInvite = isfile('Invite.CARAMEL') and readfile('Invite.CARAMEL') or nil
if Request then
    local Invite
    local r = Request(
    {
       ...
       --[[ ['Headers'] = {
        ...
        ['Url'] = 'https://raw.githubusercontent.com/HexerMaster1929/CARMLWARE/main/DISCORD.txt'
    })
    ...
    if not CurrentDiscordInvite or CurrentDiscordInvite ~= Invite then
        ...
        writefile('Invite.CARAMEL',Invite)
    end
end
		end,
	})

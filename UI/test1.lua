...
function ChangeTheme(ThemeName)
	...
	Topbar.User.UIStroke.Color = SelectedTheme.TabStroke
	Topbar.User.BackgroundColor3 = SelectedTheme.TabBackground
	Topbar.User.Thumbnail.ImageColor3 = SelectedTheme.TabTextColor
	Topbar.User.UserName.TextColor3 = SelectedTheme.TabTextColor
...
function RayfieldLibrary:Notify(NotificationSettings)
	...
	--[[if getgenv().SecureMode == nil then
		...
		if Rayfield.Name == "HexHubV7" then
...
function Hide()
	...
	TweenService:Create(Topbar.User, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	TweenService:Create(Topbar.User.UserName, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
	TweenService:Create(Topbar.User.Thumbnail, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
	--TweenService:Create(Topbar.User.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
	TweenService:Create(Topbar.User.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
...
function Unhide()
	...
	TweenService:Create(Topbar.User, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.7}):Play()
	TweenService:Create(Topbar.User.Thumbnail, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.2}):Play()
	--TweenService:Create(Topbar.User.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.7}):Play()
	TweenService:Create(Topbar.User.UserName, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 0.2}):Play()
	TweenService:Create(Topbar.User.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	Topbar.User.Visible = false
	SideBar.Visible = false
	SideBar.Settings.Visible = false
	Elements.Visible = false
	
	Topbar.User.UserName.Text = "@"..game.Players.LocalPlayer.Name
	Topbar.User.Thumbnail.Image = game.Players:GetUserThumbnailAsync(game.Players.LocalPlayer.UserId,Enum.ThumbnailType.HeadShot,Enum.ThumbnailSize.Size100x100)
	...
	SideBar.Settings.Interact.MouseButton1Click:Connect(function()
		if Minimised then return end
		...
		for _, OtherTabButton in ipairs(TabList:GetChildren()) do
			...
			Elements.UIPageLayout:JumpTo(Elements:FindFirstChild("Settings"))
...
--	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 475)}):Play()
	...
	function Window:SetTabOrder(ORDERNUM)
